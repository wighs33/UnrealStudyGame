...
struct D1GAME_API FLyraContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class D1GAME_API ULyraActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class D1GAME_API ULyraContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
